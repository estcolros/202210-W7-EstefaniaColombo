...
const tyrion = new Advisor('Tyrion', 'Lannister', 39, true, "I don't know why, but I think I'm going to die soon", '/assets/images/tyrion.jpg', 'Daenerys');
const bronn = new Squire('Bronn', 'AguasNegras', 56, true, "I'm a loser", '/assets/images/bronn.jpg', 0, 'Jaime');
