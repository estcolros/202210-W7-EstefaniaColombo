...
const comunicateListeners = () => {
    const nodeList = document.querySelectorAll('.character__action--comunicate');
    nodeList.forEach((item) => {
